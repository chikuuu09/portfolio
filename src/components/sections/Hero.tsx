...
const skills = ["Java", "DevOps", "Cloud"];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <TextType
              text={["Java Developer", "DevOps Enthusiast", "Cloud Learner"]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
        ...
        >
          ...
          >
            B.Tech Computer Science Engineering student passionate about Java,
            DevOps, and cloud technologies. Focused on learning modern tools,
            building practical projects, and continuously improving technical skills.
          </p>
        </motion.div>
